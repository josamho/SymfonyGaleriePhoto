(function($) {
    var methods = {
        ...
        addSuccess: function(message) {
            var flashMessageElt = methods.getBasicFlash(message).addClass('positive');
        ...
        addError: function(message) {
            console.log(message);
            var flashMessageElt = methods.getBasicFlash(message).addClass('negative');
        ...
        addInfo: function(message) {
            var flashMessageElt = methods.getBasicFlash(message).addClass('info');
        ...
        getBasicFlash: function(message) {
            var flashMessageElt = $('<div></div>')
                .hide()
                .addClass('ui message ten wide column')
